...
st.set_page_config(page_title="금강수계 AI V143", layout="wide", initial_sidebar_state="collapsed")
st.markdown("""<style>
...
</style><div class="fixed-header">🌊 금강수계 수질자동측정망 AI V143</div>""", unsafe_allow_html=True)
        ...
        with st.spinner("지식 검색 중..."):
            ...
            with res_col:
                if final:
                    ...
                    for d in final[:8]:
                        v_mark = ' ✅ 전문가 인증' if d.get('is_verified') else ''

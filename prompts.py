...
PROMPTS = {
    ...
    # ----------------------------------------------------------------
    "search_intent": """사용자의 질문에서 '타겟 모델명', '측정 항목', '제조사'를 완벽하게 추출해.
        질문: {query}
    ...
    # ----------------------------------------------------------------
    "summary_fact_lock": """[Role] You are a strict technical manual assistant.
    [Question] {query}
    [Data] {context}
    ...
    # ----------------------------------------------------------------
    # 5. 통합 랭킹 및 요약 (Unified Rerank & Summary)
    # ----------------------------------------------------------------
    "unified_rerank": "질문:{query} 조건:{safe_intent} 후보:{candidates} 평가 및 3줄요약해. JSON응답.",

    # ----------------------------------------------------------------
    # 6. 심층 리포트 (Deep Report)
    # ----------------------------------------------------------------
    "deep_report": """
